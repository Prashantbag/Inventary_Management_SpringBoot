...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<ResponseStructure<String>> adminRegisterNotAllowedExceptionHandler(
			AdminRegisterNotAllowedException exception) {
		ResponseStructure<String> responseStructure = new ResponseStructure<String>();
	...
	@ExceptionHandler
	public ResponseEntity<ResponseStructure<String>> itemQuantityExceededExceptionHandler(
			ItemQuantityExceededException exception) {

		ResponseStructure<String> responseStructure = new ResponseStructure<String>();
		responseStructure.setStatus(HttpStatus.FORBIDDEN.value());
		responseStructure.setMessage("Item exceeds the maximum quantity");
		responseStructure.setData(exception.getMessage());
		ResponseEntity<ResponseStructure<String>> responseEntity = new ResponseEntity<ResponseStructure<String>>(
	...
	public ResponseEntity<ResponseStructure<String>> validationExceptionHandler(
		...
		ResponseStructure<String> responseStructure = new ResponseStructure<String>();
		responseStructure.setStatus(HttpStatus.FORBIDDEN.value());
		responseStructure.setMessage("Field Not Valid");
